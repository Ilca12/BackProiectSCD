...
public class DepartmentController {
    ...
    public Department updateManagerDepartment(@PathVariable int id,@RequestBody Department department)
    {
        return departmentService.updateManagerDepartment(id,department);
    }
